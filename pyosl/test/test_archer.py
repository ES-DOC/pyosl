...
from pyosl.tools import named_build, calendar_period, osl_fill_from, online, numeric_value
from pyosl.tools import osl_encode2json


def make_archer():
    """ As an example, let's minimally describe ARCHER"""
