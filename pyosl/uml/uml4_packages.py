...
#
# note these cannot be used unless the calling routine does the following
# we don't do it here to avoid problems with imports that use this and other things ...
#
